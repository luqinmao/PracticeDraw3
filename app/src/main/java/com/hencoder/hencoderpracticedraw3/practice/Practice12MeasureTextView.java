...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float text1measure = paint1.measureText(text1);
        float text2measure = paint2.measureText(text2);

        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 +text1measure, 200, paint2);
        canvas.drawText(text3, 50 + text1measure+text2measure, 200, paint1);
    }
}
